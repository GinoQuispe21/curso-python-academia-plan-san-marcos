...
window.resizable(width=False, height=False) # Permite que se reajuste el tamanio de la ventan
...
window.config(background = "#378a62") # el background/ fondo -> permite colocar el color de manera textual: "green" o poniendo el codigo hexadecimal
